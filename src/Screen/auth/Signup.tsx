...
async function auth(){
  const response =await fetch('https://telecom-backend-beta.vercel.app/api/auth/google/request',{method:'post'});
...
export default function SignupPage() {
  ...
  // const isAdminRoute = location.pathname.includes("/admin/signup");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      backendCall({
        ...
        .then((response) => {
          // const signupResponse = response as unknown as SignupResponse;
            ...
            <CardContent sx={{ p: 4 }}>
              ...
              <Box sx={{ textAlign: "center", mb: 4 }}>
                ...
                <Typography
                  ...
                  sx={{ mt: 1 }}
                >
                  {formData.role === "admin" ? "Admin" : ""} Sign up to get
              ...
              <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                <Button
                  variant="outlined"
                  fullWidth
                  onClick={()=>auth()} // Added onClick handler
                  startIcon={
                    <svg
                      width="18"
                      height="18"
